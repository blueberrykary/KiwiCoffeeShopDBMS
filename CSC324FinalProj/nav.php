<div class="bg-1" style="margin-bottom: -30px;">
...
<div class="menu-wrap">
				...
				<ul class="sf-menu">
					<li>
						<a href="index.php"><img src="imgs/kclogo.png" style=" width: 70%; margin-left: 45%; margin-top: -12px; margin-bottom: -10px;"></a>
					</li>
					<li>
                                            <a href="Cafe_Menu.php">Order</a>
						...
						<?php
						 ...
						 ?>
                                                    <li><a href="Cafe_Menu.php?id=<?php echo $catr['id']; ?>"><?php echo $catr['name']; ?></a></li>
						<?php } ?>
						</ul>
					</li>
					...
					<li>
                                            <a href="#">Admin</a>
                                            <ul>
                                                <li><a href="admin_loc/login.php">Login</a>
                                            </ul>
					</li>
				</ul>
					...
					<div class="s-cart">
						...
						<div class="cart-info">
							...
							<?php
							 ...
							 ?>
							<div class="ci-item">
                                                            <img src="admin_loc/<?php echo $navcartr['thumb']; ?>" width="70" alt=""/>
