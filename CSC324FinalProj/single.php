						...
						<div class="col-md-5">
							<div class="gal-wrap ">
								<div id="gal-slider" class="flexslider">
									<ul class="slides ">
										<li><img src="admin_loc/<?php echo $prodr['thumb']; ?>" class="img-responsive zoom" alt=""/></li>
									</ul>
								</div>
								<ul class="gal-nav">
									<li>
										<div>
											<img src="admin_loc/<?php echo $prodr['thumb']; ?>" class="img-responsive" alt=""/>
										</div>
									</li>
								</ul>
							...
							<div class="product-quantity">
								<span>Quantity:</span> 
									<input type="hidden" name="id" value="<?php echo $prodr['id']; ?>">
                                                                        <input type="text" name="quant" style="width: 50px;" placeholder="1">
							</div>
								...
								<div class="sm-item isotope-item">
									<div class="product">
										<div class="product-thumb">
											<img src="admin_loc/<?php echo $relr['thumb']; ?>" class="img-responsive" alt="">
											<div class="product-overlay">
												<span>
												<a href="single.php?id=<?php echo $relr['id']; ?>" class="fa fa-eye"></a>
