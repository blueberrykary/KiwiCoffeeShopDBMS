		...
		<div class="content-blog content-account">
			...
			<table class="cart-table account-table table table-bordered">
				...
				<?php
					...
					$orditmsql = "SELECT * FROM contains o JOIN products p WHERE o.orderid=$oid AND o.pid=p.id";
				...
				?>
					<tr>
						...
						<td>
							<?php echo $orditmr['pqty']; ?>
						</td>
						<td>
							$ <?php echo $orditmr['producthprice']; ?>
						</td>
						<td>
							
						</td>
						<td>
							$ <?php echo $orditmr['producthprice']*$orditmr['pqty']; ?>
						</td>
					</tr>
				<?php } ?>
					<tr>
			...
			<div class="row">
				<div class="col-md-6">
					...
					<?php
						$csql = "SELECT u1.fname, u1.lname, u1.street, u1.city, u1.state, u.email, u1.mobile, u1.zip FROM customer u JOIN customerinfo u1 WHERE u.id=u1.uid AND u.id=$uid";
